import numpy as np
from trajectory_generation.objectives.objective_variables import get_control_points, get_scale_factor, get_orbit_radius
...
def minimize_jerk_control_points_and_time_objective_function(variables, num_cont_pts, dimension):
    ...
    orbit_radius = get_orbit_radius(variables)
    ...
    objective = np.sum(square_jerk_control_points) * scale_factor + 100/orbit_radius**2
    return objective
